                  ...
                  <CCard style={{ marginTop: "200px" }} >
                    ...
                    <CCardBody className="Ccard-design-end">
                      ...
                      <CRow>
                        ...
                        <CCol lg="8"><CInput type="text" className="input-field-blue-background" value={userName} onChange={userNameChange} onKeyDown={keyDownHandler} /></CCol>
                      </CRow>

                      <CRow className="mt-3">
                        <CCol lg="4"><h5 style={{ marginTop: "7px" }}>Password</h5></CCol>
                        <CCol lg="8"><CInput type="password" className="input-field-blue-background" value={password} onChange={passwordChange} onKeyDown={keyDownHandler} /></CCol>
                      </CRow>
        ...
        <div className="login-bg-mobile">
          ...
          <CRow lg="12" style={{ paddingLeft: "100px", paddingRight: "100px" }}>
            ...
            <CCol lg="6">
              ...
              <br></br>
              <CInput type="text" value={userName} className="input-field-blue-background" onChange={userNameChange} onKeyDown={keyDownHandler} />
              <br></br>
              <label
                style={{
                  fontWeight: "800",
