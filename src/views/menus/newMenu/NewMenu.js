...
const NewMenu = () => {
  ...
  const [appliedDateSelectedValue, setAppliedDateSelectedValue] = useState("");
  ...
  const saveClick = () => {
    ...
    if (!nullChk(appliedDateSelectedValue)) {
  ...
  const saveOK = () => {
    ...
    localStorage.setItem("BIRTHDAY", appliedDateSelectedValue);
    ...
    <>
      ...
      <CRow>
        <CCol lg="6">
          ...
          <CRow>
            <CCol lg="1"></CCol>
            <CCol lg="3">Birthday <span style={{ color: "red" }}>*</span></CCol>
            <CCol lg="8">
        ...
        <CCol lg="6">
          ...
          <CRow>
            <CCol lg="1"></CCol>
            <CCol lg="3">Photo <span style={{ color: "red" }}>*</span></CCol>
            <CCol lg="8">
      ...
      <CRow>
        <CCol lg="6">
          <CRow>
            <CButton className="btn btn-success" onClick={popUpClick} >PopUp</CButton>
          </CRow>
        </CCol>
        <CCol lg="6">
          <CRow style={{ justifyContent: "right" }}>
            <CButton className="btn btn-danger" onClick={deleteClick} >Delete</CButton>
          </CRow>
        </CCol>
      </CRow>
